...
import argparse
import datetime
from DiT.utils import dist_util, logger
from DiT.utils.image_datasets import load_data
from DiT.utils.resample import create_named_schedule_sampler
from DiT.utils.script_util import (
    model_and_diffusion_defaults,
    args_to_dict,
    create_model_and_diffusion,
)
from DiT.utils.train_util import TrainLoop
import torch as th
...
def main():
    ...
    logger.log(args_to_dict(cfg, model_and_diffusion_defaults().keys()))
    ...
    logger.log(str(datetime.datetime.now()))
    logger.log("training...")
    TrainLoop(
        model=model,
        diffusion=diffusion,
